...
export enum PrismaQueryError {
  ...
  /**
   * Unique enumraint failed on the `{enumraint}`
   */
  UniqueenumraintViolation = 'P2002',

  /**
   * Foreign key enumraint failed on the field: `{field_name}`
   */
  ForeignenumraintViolation = 'P2003',

  /**
   * A enumraint failed on the database: `{database_error}`
   */
  ...
  /**
   * Null enumraint violation on the `{enumraint}`
   */
  NullenumraintViolation = 'P2011',
...
export enum PrismaMigrationError {
  /**
